...
ARG CLAUDE_CODE_TIPS_VERSION=v0.26.20
...
RUN jq '. + {hasCompletedOnboarding: true, hasAcceptedBypassPermissionsMode: true, autoCompactEnabled: false}' /home/sclaw/.claude.json > /tmp/.claude.json.tmp && \
