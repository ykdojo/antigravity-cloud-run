---
title: How I drive a cloud coding agent from my phone through the browser
published: false
description: Putting Identity-Aware Proxy in front of a Cloud Run service so a coding agent's web terminal opens from any phone browser.
tags: googlecloud, ai, webdev, devops
cover_image: https://raw.githubusercontent.com/ykdojo/antigravity-cloud-run/main/assets/covers/cover-devto.png
canonical_url: https://ykdojo.github.io/antigravity-cloud-run/posts/phone-access-iap.html
---
...
![Driving an agy session from my phone: asking it to summarize the latest three episodes of a podcast, and watching it search](https://raw.githubusercontent.com/ykdojo/antigravity-cloud-run/main/assets/phone-access-terminal-phone.png)
...
setup](https://ykdojo.github.io/antigravity-cloud-run/posts/ephemeral-dev-environments.html): the agent runs with
...
1. **Branding** (console, Google Auth Platform → Overview → Get started): app
   ...
   ![The Auth Platform branding wizard](https://raw.githubusercontent.com/ykdojo/antigravity-cloud-run/main/assets/phone-access-branding-step1.jpg)
...
![The dashboard listing a laptop session with a connect button and a phone session with an iap badge and an open-in-browser link](https://raw.githubusercontent.com/ykdojo/antigravity-cloud-run/main/assets/phone-access-dashboard-iap.jpg)

It's a checkbox when creating a session too, off by default:

![The new cloud session dialog with a phone access via IAP checkbox](https://raw.githubusercontent.com/ykdojo/antigravity-cloud-run/main/assets/phone-access-new-session-modal.jpg)
